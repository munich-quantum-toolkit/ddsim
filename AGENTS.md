...
- Install package without build isolation (fast rebuilds): `uv sync --inexact --no-dev --no-build-isolation-package mqt-ddsim`
...
- NEVER edit `.pyi` files in `python/mqt/ddsim/` manually; they are auto-generated by nanobind stubgen.
