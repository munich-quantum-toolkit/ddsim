...
Afterward, navigate to the [Releases page](https://github.com/munich-quantum-toolkit/ddsim/releases) on GitHub, edit the created draft, and publish the release.
